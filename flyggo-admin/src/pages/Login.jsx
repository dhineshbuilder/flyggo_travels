    ...
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-white/90 backdrop-blur-xl rounded-[2.5rem] p-10 shadow-2xl border border-white/50 text-center">
        ...
        <form onSubmit={handleLogin} className="space-y-6 text-left">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                type="email" 
                required
                className="w-full bg-slate-100/50 border border-slate-200 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 transition-shadow"
          ...
          <button 
            type="submit"
            className="w-full py-3 rounded-xl text-white font-medium transition-transform hover:scale-[1.02] shadow-md flex items-center justify-center gap-2"
